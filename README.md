...
### 4. MCMC extension execution lock

The MCMC extension execution configuration, MPI/thread benchmark results, and runtime compatibility rules were frozen before any chain extension under:

```text
v0.1.3-mcmc-extension-lock
```

- **Version DOI:** [10.5281/zenodo.21400103](https://doi.org/10.5281/zenodo.21400103)
